...
#include "/home/student/csci-315-spring-2019/class-code/09-singly-link-list/test/insert-test.cpp"

static MyTestSuite1 suite_MyTestSuite1;

static CxxTest::List Tests_MyTestSuite1 = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_MyTestSuite1( "test/insert-test.cpp", 8, "MyTestSuite1", suite_MyTestSuite1, Tests_MyTestSuite1 );
...
public:
 TestDescription_suite_MyTestSuite1_test2() : CxxTest::RealTestDescription( Tests_MyTestSuite1, suiteDescription_MyTestSuite1, 28, "test2" ) {}
