...
\vskip.15in
\noindent\textbf{Office Hours:} TR 0800-0920, T 1200-1530, R 1200-1350 and by appointment.
...
I drive most of my classes from github.  Assignments and lectures are located on Github here: \url{https://github.com/csu-cs/csci-315-spring-2019}.  If you are not able to view, please send me an email so I can grant you access.\\
...
\vskip.15in
\noindent\textbf{Attendance and Late Work:} I will not be enforcing an attendance policy.  Any late work will receive a 20\% penalty and I will not accept late work after April 23, 2019.
...
nd half of the semester. Students are strongly encouraged to complete the short evaluation, which is entirely anonymous. Your professor will let you know when this is active, and you can then access it through your MyCSU account. We greatly value your opinion!
...
\begin{flushleft}
Drop/Add Deadline \dotfill January 11\\
Withdraw with 'W' \dotfill March 15 \\
Course Final \dotfill April 26\\
\end{flushleft}
\end{minipage}
\end{center}
